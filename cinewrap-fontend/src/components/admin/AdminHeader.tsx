...
export const AdminHeader: React.FC<AdminHeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 h-20 border-b border-white/10 bg-[#131c2e]/60 px-4 backdrop-blur-xl sm:px-6 lg:px-8">
      <div className="flex h-full items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          >
            <Globe className="h-4 w-3.5 text-[#00a3ff]" strokeWidth={2.4} />
          ...
          <div className="hidden items-center gap-3 border-l border-white/10 pl-2 sm:flex">
            <div className="flex h-10 w-10 items-center justify-center rounded-full border border-[#00a3ff]/40 bg-[#00a3ff]/20 text-[#00a3ff]">
